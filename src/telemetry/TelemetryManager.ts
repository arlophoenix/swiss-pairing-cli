...
import { TelemetryManagerInput } from './telemetryTypes.js';
...
export class TelemetryManager {
   ...
   */
  constructor({ shouldShowTelemetryNotice }: TelemetryManagerInput) {
   ...
   *
   * @example
   * manager.recordError(new Error("File not found"));
   * // Records:
   * // - error_name: "Error"
